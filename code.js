...
function setup(){
  ...
  up = createSprite(windowWidth/2-370,windowHeight-150,50,50);
  // up.scale= 0.09;
  // up.addImage(upImg);

  down = createSprite(windowWidth/2+370,windowHeight-150,50,50);
  // down.scale= 0.25;
  // down.addImage(downImg);

  left = createSprite(windowWidth/2-370,windowHeight-50,50,50);
  // left.scale= 0.25;
  // left.addImage(leftImg);
  
  right = createSprite(windowWidth/2+370,windowHeight-50,50,50);
  // right.scale= 0.25;
  // right.addImage(rightImg);

  na = createSprite(windowWidth/2-480,windowHeight-90);
  na1 = createSprite(windowWidth/2+500,windowHeight-90);
  na2 = createSprite(windowWidth/2-500,windowHeight+18);
  na3 = createSprite(windowWidth/2+500,windowHeight+18);
